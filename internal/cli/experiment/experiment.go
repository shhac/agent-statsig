...
func Register(root *cobra.Command, globals func() *shared.GlobalFlags) {
	...
	libcli.HandleUnknownCommand(exp, "run 'agent-statsig experiment usage' to see the available commands")
